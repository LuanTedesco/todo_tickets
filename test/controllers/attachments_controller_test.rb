...
class AttachmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attachment" do
    assert_difference("Attachment.count") do
      post attachments_url, params: { attachment: { description: @attachment.description, status: @attachment.status, title: @attachment.title, url: @attachment.url } }
    end
  ...
  test "should update attachment" do
    patch attachment_url(@attachment), params: { attachment: { description: @attachment.description, status: @attachment.status, title: @attachment.title, url: @attachment.url } }
