...
class SubTasksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sub_task" do
    assert_difference("SubTask.count") do
      post sub_tasks_url, params: { sub_task: { date_end: @sub_task.date_end, name: @sub_task.name } }
    end
  ...
  test "should update sub_task" do
    patch sub_task_url(@sub_task), params: { sub_task: { date_end: @sub_task.date_end, name: @sub_task.name } }
